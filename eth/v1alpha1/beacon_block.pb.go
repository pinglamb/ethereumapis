...
type BeaconBlock struct {
	...
	ShardHeaders         []*ShardHeader   `protobuf:"bytes,6,rep,name=shard_headers,json=shardHeaders,proto3" json:"shard_headers,omitempty" ssz-max:"128"`
...
func (m *BeaconBlock) GetShardHeaders() []*ShardHeader {
	if m != nil {
		return m.ShardHeaders
	}
	return nil
}
...
type BeaconBlockBody struct {
	...
	SyncCommitteeBits      github_com_prysmaticlabs_go_bitfield.Bitvector1024 `protobuf:"bytes,10,opt,name=sync_committee_bits,json=syncCommitteeBits,proto3,casttype=github.com/prysmaticlabs/go-bitfield.Bitvector1024" json:"sync_committee_bits,omitempty" ssz-size:"128"`
...
func (m *BeaconBlockBody) GetSyncCommitteeBits() github_com_prysmaticlabs_go_bitfield.Bitvector1024 {
	if m != nil {
...
func (m *BeaconBlockBody) GetSyncCommitteeSignature() []byte {
	if m != nil {
...
var fileDescriptor_6abbd9d98bd3d11a = []byte{
	...
	,
}
...
func (m *BeaconBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ShardHeaders) > 0 {
		for iNdEx := len(m.ShardHeaders) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ShardHeaders[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *BeaconBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShardHeaders", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ShardHeaders = append(m.ShardHeaders, &ShardHeader{})
			if err := m.ShardHeaders[len(m.ShardHeaders)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
